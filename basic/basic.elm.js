...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var outPort = Elm.Native.Port.make(_elm).outboundSignal("outPort",function (v) {    return v;},A2($Signal.map,$Basics.fst,$Mouse.position));
   var inPort = Elm.Native.Port.make(_elm).inboundSignal("inPort",
   "Int",
   function (v) {
   ...
   function (i) {
      return A2($Graphics$Element.flow,$Graphics$Element.right,_U.list([$Graphics$Element.show("in:"),$Graphics$Element.show(i)]));
   },
   inPort);
